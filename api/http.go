...
import (
	...
	"github.com/go-chi/chi" // GorillaMux with Middleware
	"github.com/pkg/errors"

	js "github.com/zeroquark/hexagonal/serializer/json"
	ms "github.com/zeroquark/hexagonal/serializer/msgpack"
...
func setupReponse(w http.ResponseWriter, contentType string, body []byte, statusCode int) {
...
func (h *handler) Post(w http.ResponseWriter, r *http.Request) {
	...
	setupReponse(w, contentType, responseBody, http.StatusCreated)
}
